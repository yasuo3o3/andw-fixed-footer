...
### Changed
- Complete migration to unified `andwff` prefix throughout codebase
- Admin UI internationalization with English defaults while maintaining i18n support
- Proper WordPress asset enqueuing implementation for admin styles

### Fixed
- WordPress.org plugin review compliance issues
- Inline admin styles replaced with proper enqueue system
- Form identifiers and nonce actions updated for consistency
- JavaScript settings object naming alignment (`andwffSettings`)
- Uninstall script updated to clean both legacy and new option names

### Removed
- Inline `<style>` blocks from admin interface
- Inconsistent prefix usage across different components
